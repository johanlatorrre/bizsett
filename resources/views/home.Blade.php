...
<div class="container-fluid">
  ...
  @auth
    ...
    <div class="row">
      ...
      {{-- Opciones superiores del home --}}
        <div class="card col-6 mb-4" style=" background-color:#f1f1f1; border-radius: 15px">

          <div class="d-flex justify-content-between mx-15 my-2 p-1 w-1/1">

            <a class="btn btn-dark mx-2" href="{{route('perfilemp.me')}}">
              <img src="storage\img\bx-store-white.svg" alt="">
            </a>
            
            <a class="btn btn-secondary mx-2" href="">
                <img src="storage\img\bxs-chat.svg" alt="">
            </a>
                          ...
                          <div class="col-8">
                            <div class="row">
                              <div class="col-2">
                                @if ($user->foto_perfil == 'null')
                                  <a href="{{route('perfilemp.user', $emprendimiento)}}">
                                      <img class="rounded-circle mx-3" src="{{asset('storage\img\undraw_avatar.svg')}}" style="width: 30px; height: 30px;">
                                  </a>
                                @else
                                  <a href="{{route('perfilemp.user', $emprendimiento)}}">
