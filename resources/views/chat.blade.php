<html lang="en">
  ...
  <div  class="font-semibold	font-weight: 600; w-3/12 p-6">
  ...
  <h3 class="text-2xl mb-8">chat en linea</h3>
    ...
    <div class="flex overflow-auto w-full mb-8">
      ...
      <div class="self-center text-center mr-4">
            ...
            <div class="absolute bg-green-300 p-1 rounded-full bottom-0 right-0border-gray-800 border-2"></div>
            </div> 
              <small class="font-light">Diego </small>
      ...
      <div class="self-center text-center mr-4">
          <div class="relative w-12 mb-2">
            <img src="https://images.unsplash.com/photo-1611077877535-82353626c118?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fGZvdG9zfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" class="rounded-full">
            <div class="absolute bg-green-500 p-1 rounded-full bottom-0 right-0border-gray-800 border-2"></div>
          </div>
              <small>Diego</small>
      </div>
        ...
        <div class="flex bg-gray-100 rounded p-4 mb-4">
          ...
          <div class="w-full overflow-hidden">
            <div class="flex mb-1">
              ...
              <small class="font-light text-gray-500">09:58 am</small>
            </div>
                <small class="overflow-ellipsis overflow-hidden whitespace-nowrap block font-light text-gray-500 "> 
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt ullam tempora nostrum voluptates. Molestiae alias
                </small>
  ...
  <div class="bg-gray-100 w-9/12"> 
    ...
    <div class="py-6 px-20 overflow-auto h-3/4">
    ...
    <div class="bg-white p-6 w-96  rounded-3xl rounded-bl-none shadow-sm
    mb-2">
  ...
  <div class="flex mb-12  flex-row-reverse" > 
    ...
    <div class="flex flex-col">
    <div class="bg-white p-6 w-96  rounded-3xl rounded-bl-none shado-sm
    mb-2">
  ...
  <div class="flex mb-12"> 
    <img src="https://images.unsplash.com/photo-1611077877535-82353626c118?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fGZvdG9zfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" class="self-end rounded-full w-12 mr-4">
    <div class="flex flex-col">
    <div class="bg-white p-6 w-96  rounded-3xl rounded-bl rounded-br-none shado-sm
    mb-2">
      ...
      <div class="flex mb-12 flex-row-reverse" > 
        <img src="https://images.unsplash.com/photo-1611077877535-82353626c118?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fGZvdG9zfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" class="self-end rounded-full w-12 ml-4">
        <div class="flex flex-col">
        <div class="bg-white p-6 w-96  rounded-3xl rounden-bl rounded-br-none shado-sm
        mb-2">
      ...
      <input type="text" class="px-4 py-2 bg-gray-100 w-full focus:outline-none
        font-light" placeholder="Escribe tu mensaje..">
